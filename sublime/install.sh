...
then
  ...
  ln -s $FOLDER/Default\ \(Linux\).sublime-keymap ~/.config/sublime-text-2/Packages/User/Default\ \(Linux\).sublime-keymap
  ...
  ln -s $FOLDER/Package\ Control.sublime-settings ~/.config/sublime-text-2/Packages/User/
